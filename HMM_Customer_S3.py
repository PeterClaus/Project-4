...
states, observations, start_probability, transition_probability, emission_probability = model_open('HMM_S3.txt')

'''
# Set all the emission_probability be the same
for i in emission_probability:
    for j in emission_probability[i]:
        emission_probability[i][j] = 0.5
'''
...
print('The average accuracy is: ' + str(round(sum(Average_accuracy)/len(Average_accuracy), 2)))
